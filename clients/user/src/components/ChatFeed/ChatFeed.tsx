...
//           selectedGroup?.chats?.map((chat, index) => {
//             return (
//               // <div key={chat._id || index} className="flex items-center">
//               //   <Response data={chat} />
//               <>
//               <Response key={chat._id || index} data={chat} />
//                 {/* <TextToSpeech text={chat.answer?.replace(/\n+/g, ' ').trim()} /> Add the TextToSpeech component here */}
//                 </>
//             );
//           })
//         )}
