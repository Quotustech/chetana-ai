...
const SignIn: React.FC = () => {
    ...
    try{
      ...
      dispatch(login({
          ...
          if (login.fulfilled.match(result)) {
            const payload = result.payload; // PayloadAction<LoginResponse, string, { arg: LoginData; requestId: string; requestStatus: "fulfilled"; }, never>
            if (payload.success) {
  ...
  return (
    <>
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark flex h-[100svh] justify-center">
